            ...
            <form onSubmit={handleProfileSubmit}>
              ...
              {user?.role === 'Member' && (
                <div className="row g-3 mb-3">
                  <div className="col-md-6">
                    ...
                    <input type="text" className="form-control bg-light" value="M0001" disabled />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label fw-semibold small">Tanggal Bergabung</label>
                    <input type="text" className="form-control bg-light" value="2024-01-15" disabled />
                  </div>
                </div>
              )}
              ...
              {user?.role === 'Staff' && (
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control bg-light" value="S0001" disabled />
                </div>
              )}
              ...
              <div className="row g-3 mb-3">
                <div className="col-md-6">
                  ...
                  <select className="form-select" defaultValue="Mr." required>
              ...
              <div className="row g-3 mb-3">
                <div className="col-md-6">
                  <label className="form-label fw-semibold small">Nama Depan</label>
                  <input type="text" className="form-control" defaultValue={user?.nama.split(" ")[0]} required />
                </div>
                <div className="col-md-6">
                  <label className="form-label fw-semibold small">Nama Tengah</label>
              ...
              <div className="row g-3 mb-3">
                ...
                <div className="col-md-6">
                  ...
                  <select className="form-select" defaultValue="Indonesia" required>
              ...
              <div className="row g-3 mb-3">
                <div className="col-md-6">
                  ...
                  <select className="form-select" defaultValue="+62" required>
                ...
                <div className="col-md-6">
                  ...
                  <input type="text" className="form-control" defaultValue="81234567890" required />
                </div>
              </div>
              ...
              <div className="row g-3 mb-4">
                <div className="col-md-6">
                  ...
                  <input type="date" className="form-control" defaultValue="1990-05-15" required />
                </div>
                {user?.role === 'Staff' && (
                  <div className="col-md-6">
                    <label className="form-label fw-semibold small">Kode Maskapai</label>
                    <select className="form-select" defaultValue="GA" required>
